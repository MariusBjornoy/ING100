...
if online
    ...
    %------------------------------------------------
    % Initialiser sensorer (kommenter bort de du ikke bruker)
    %------------------------------------------------
    ...
    % montert p? inngang 3 og 4, m? du spesifisere dette som:
    % mySonicSensor_1 = sonicSensor(mylego,3);
    % mySonicSensor_2 = sonicSensor(mylego,4);
    %------------------------------------------------
        
    %------------------------------------------------
    % Initialiser motorer (kommenter bort de du ikke bruker)
    %------------------------------------------------
